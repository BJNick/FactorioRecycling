...
function Add_Recylcer(recycler_name, recycler_crafting_group, recycler_tint, recycler_slots)
  data:extend(
  {
    {
      type = "furnace",
...
Add_Recylcer("iron-recycling-furnace", "iron-recycling", {r=0.8,g=0.8,b=1,a=1}, 1)
Add_Recylcer("copper-recycling-furnace", "copper-recycling", {r=1,g=0.75,b=0.75,a=1}, 1)
Add_Recylcer("both-recycling-furnace", "both-recycling", {r=0.8,g=1,b=0.8,a=1}, 2)